...
Commands:
    youtube-watch-mcp-cli info URL              -> title, duration, chapters, captions
    youtube-watch-mcp-cli transcript URL        -> clean transcript to file, print path + preview
    youtube-watch-mcp-cli search URL "query"    -> timestamped matching cues
    youtube-watch-mcp-cli segment URL START END -> text in a time range (seconds)
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="youtube-watch-mcp-cli", description="YouTube watch engine.")
